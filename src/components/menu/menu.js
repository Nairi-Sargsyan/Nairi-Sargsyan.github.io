                            ...
                            <div className="menu__content_body">
                                <div className="menu__items_block mb-5">
                                    ...
                                    <div className="menu__item mb-4 w-100 d-flex justify-content-between align-items-center">
                                        <img className="me-3" src="./icons/menu__icon_01.png" alt="Raw Scallops from Erquy" />
                                        ...
                                        <h5 className="info__text_title mb-0 ms-3">$40</h5>
                                    </div>
                                    <div className="menu__item mb-4 w-100 d-flex justify-content-between align-items-center">
                                        <img className="me-3" src="./icons/menu__icon_02.png" alt="Spring Roll" />
                                        <div className="item__inner me-auto">
                                            <h4 className="info__text_title">Spring Roll</h4>
                                            <p className="info__text_subtitle">Add oil to a hot pan spring onion whites</p>
                                        </div>
                                        <h5 className="info__text_title mb-0 ms-3">$20</h5>
                                    </div>
                                    <div className="menu__item mb-4 w-100 d-flex justify-content-between align-items-center">
                                        <img className="me-3" src="./icons/menu__icon_03.png" alt="French Onion Soup" />
                                        <div className="item__inner me-auto">
                                ...
                                <div className="menu__items_block mb-5">
                                    ...
                                    <div className="menu__item mb-4 w-100 d-flex justify-content-between align-items-center">
                                        <img className="me-3" src="./icons/menu__icon_06.png" alt="Roast Beef with Vegetable" />
                                        <div className="item__inner me-auto">
                                    ...
                                    <div className="menu__item mb-4 w-100 d-flex justify-content-between align-items-center">
                                        <img className="me-3" src="./icons/menu__icon_07.png" alt="Marrkesh Vegetetarian Curruy" />
                                        <div className="item__inner me-auto">
                                    ...
                                    <div className="menu__item w-100 d-flex justify-content-between align-items-center">
                                        <img className="me-3" src="./icons/menu__icon_08.png" alt="Spicy Vegan Potato Curry" />
                                        <div className="item__inner me-auto">
                                        ...
                                        <h5 className="info__text_title mb-0 ms-3">$35</h5>
                                    </div>
                                </div>
                                <div className="menu__items_block">
                                    <h4 className="block__title mb-5">Dessert</h4>
                                    <div className="menu__item mb-4 w-100 d-flex justify-content-between align-items-center">
                                        <img className="me-3" src="./icons/menu__icon_09.png" alt="Apple Pie with Cream" />
                                        <div className="item__inner me-auto">
                                            <h4 className="info__text_title">Apple Pie with Cream</h4>
                                            <p className="info__text_subtitle">Whipping cream, egg white, cinnamon</p>
                                        </div>
                                        <h5 className="info__text_title mb-0 ms-3">$15</h5>
                                    </div>
                                    <div className="menu__item mb-4 w-100 d-flex justify-content-between align-items-center">
                                        <img className="me-3" src="./icons/menu__icon_10.png" alt="Lemon Meringue Pie" />
                                        <div className="item__inner me-auto">
